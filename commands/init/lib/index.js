...
class InitCommand extends Command {
  ...
  async downloadTemplate() {
    ...
    // Package
    const targetPath = path.resolve(userHome, '.zml-lerna-test', 'template');
    const storeDir = path.resolve(userHome, '.zml-lerna-test', 'template', 'node_modules');
  ...
  async getProjectInfo() {
    ...
    if (type === TYPE_PROJECT) {
      ...
      return {
        type,
        className: kebabCase(project.projectName),
        ...project,
      }
    } else {
